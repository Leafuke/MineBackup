...
set(MINEBACKUP_LINUX_SOURCES ${MINEBACKUP_PLATFORM_DIR}/Platform_linux.cpp)
set(MINEBACKUP_MACOS_SOURCES ${MINEBACKUP_PLATFORM_DIR}/Platform_macos.cpp ${MINEBACKUP_PLATFORM_DIR}/Platform_macos_tray.mm)
...
set(MINEBACKUP_PUBLIC_HEADERS
    ...
    ${MINEBACKUP_CORE_DIR}/MigrationCoordinator.h ${MINEBACKUP_CORE_DIR}/V15MigrationAdapter.h ${MINEBACKUP_CORE_DIR}/TaskSystem.h ${MINEBACKUP_CORE_DIR}/TaskCoordinator.h
    ${MINEBACKUP_INFRA_DIR}/AppPaths.h ${MINEBACKUP_INFRA_DIR}/AtomicFileWriter.h ${MINEBACKUP_INFRA_DIR}/RotatingFileLog.h ${MINEBACKUP_INFRA_DIR}/SingleInstanceService.h ${MINEBACKUP_INFRA_DIR}/LegacyLocationDiscovery.h ${MINEBACKUP_INFRA_DIR}/LegacyLocationMigration.h ${MINEBACKUP_INFRA_DIR}/ProcessRunner.h ${MINEBACKUP_INFRA_DIR}/InterruptedTaskRecovery.h ${MINEBACKUP_INFRA_DIR}/Broadcast.h ${MINEBACKUP_INFRA_DIR}/ConfigManager.h ${MINEBACKUP_INFRA_DIR}/Console.h ${MINEBACKUP_INFRA_DIR}/i18n.h
