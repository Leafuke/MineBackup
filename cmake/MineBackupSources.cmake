...
set(MINEBACKUP_LINUX_SOURCES ${MINEBACKUP_PLATFORM_DIR}/Platform_linux.cpp ${MINEBACKUP_PLATFORM_DIR}/NetworkBackend_linux.cpp)
set(MINEBACKUP_MACOS_SOURCES ${MINEBACKUP_PLATFORM_DIR}/Platform_macos.cpp ${MINEBACKUP_PLATFORM_DIR}/Platform_macos_tray.mm ${MINEBACKUP_PLATFORM_DIR}/NetworkBackend_macos.mm)
...
set(MINEBACKUP_PUBLIC_HEADERS
    ...
    ${MINEBACKUP_CORE_DIR}/MigrationCoordinator.h ${MINEBACKUP_CORE_DIR}/V15MigrationAdapter.h ${MINEBACKUP_CORE_DIR}/TaskSystem.h ${MINEBACKUP_CORE_DIR}/TaskCoordinator.h ${MINEBACKUP_CORE_DIR}/RemoteContentService.h
